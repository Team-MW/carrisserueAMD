export default function Politique() {
  return (
    <div className="prose mx-auto w-full py-32 px-4">
      <h1 className="text-center text-4xl font-bold">
        Politique de confidentialité
      </h1>
      <p className="pt-4">
        Le site web https://carrosserie-amd31.fr est détenu par Carrosserie A.M.D 31, qui est un
      ...
      <p className="pt-4">
        ...
        https://carrosserie-amd31.fr, qui fournit également les raisons pour lesquelles
        nous devons collecter certaines données personnelles vous concernant.
        Par conséquent, vous devez lire cette politique de confidentialité avant
        d&apos;utiliser le site web de https://carrosserie-amd31.fr.
      </p>
      <p className="pt-4">
      ...
      <p className="pt-4">
        Lorsque vous visitez le https://carrosserie-amd31.fr, nous recueillons
        ...
        informations collectées automatiquement par le terme &lquot;informations
        sur les appareils&lquot;. En outre, nous pourrions collecter les données
        personnelles que vous nous fournissez (y compris, mais sans s&apos;y
        limiter, le nom, le prénom, l&apos;adresse, les informations de
      ...
      <p className="pt-4">
        ...
        ne sont pas autrement agrégées de manière à identifier un utilisateur
        particulier du système.
      </p>
      <p className="pt-4">
        Vous pouvez visiter le site web sans nous dire qui vous êtes ni révéler
        d&apos;informations, par lesquelles quelqu&apos;un pourrait vous
        ...
        vous souhaitez recevoir notre lettre d&apos;information ou fournir
        ...
        à partir du site web. Les utilisateurs qui ne savent pas quelles
        informations sont obligatoires sont invités à nous contacter via
        AMD.AUTO31@GMAIL.COM.
      </p>
      <h2 className="pt-4 text-3xl font-semibold">Vos droits :</h2>
      <p className="pt-4">
      ...
      <p className="pt-4">
        ...
        pourrions avoir avec vous (par exemple, si vous passez une commande par
        le biais du site), ou autrement pour poursuivre nos intérêts commerciaux
        légitimes énumérés ci-dessus. En outre, veuillez noter que vos
        informations pourraient être transférées en dehors de l&apos;Europe, y
      ...
      <p className="pt-4">
        ...
        ne sont pas détenus ou contrôlés par nous. Sachez que nous ne sommes pas
      ...
      <h2 className="pt-4 text-3xl font-semibold">Divulgation légale :</h2>
      <p className="pt-4">
      ...
      <h2 className="pt-4 text-3xl font-semibold">Informations de contact :</h2>
      ...
      pouvez envoyer un courriel à AMD.AUTO31@GMAIL.COM.
    </div>
  );
}
